...
console.log(
  `Losango de diagonal maior 32cm e diagonal menor 18cm: ${Exercise.diamond(
    32,
    18
  )}cm²`
);
...
console.log(
  `Losango de diagonal maior 200cm e diagonal menor 50cm: ${Exercise.diamond(
    200,
    50
  )}cm²`
);
...
console.log(
  `Losango de diagonal maior 75cm e diagonal menor 25cm: ${Exercise.diamond(
    75,
    25
  )}cm²`
);
...
console.log(
  `Trapézio de base maior 100cm, base menor 70cm e altura 50cm: ${Exercise.trapeze(
    100,
    70,
    50
  )}cm²`
...
console.log(
  `Trapézio de base maior 75cm, base menor 50cm e altura 35cm: ${Exercise.trapeze(
    75,
    50,
    35
  )}cm²`
...
console.log(
  `Trapézio de base maior 150cm, base menor 120cm e altura 80cm: ${Exercise.trapeze(
    150,
    120,
    80
  )}cm²`
