...
describe('3 - Verifica as funções e os mocks', () => {
  ...
  // substitui a função de adição do arquivo original
  ...
  // substitui a função de subtração do arquivo original
  ...
  // substitui a função de multiplicação do arquivo original
  ...
  // substitui a função de divisão do arquivo original
  ...
  // substitui a função de exponenciação do arquivo original
  ...
  // substitui a função de cáculo fatorial do arquivo original
  // ref: https://gist.github.com/macsousa/dccd2abb2c68c5958846824e975482d3
  mockFunctions.factorial = jest.fn((number) =>
    ((number === 1) ? number : number * mockFunctions.factorial(number - 1)));
