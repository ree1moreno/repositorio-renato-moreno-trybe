...
const orderModifier = (order) => {
  ...
  const novoPreco = order.payment.total = '60';
  
  console.log(`Olá ${novoComprador}, o total do seu pedido de ${pizzas[0]}, ${pizzas[1]} e ${order.order.drinks.coke.type} é R$ ${novoPreco},00.`);
}
